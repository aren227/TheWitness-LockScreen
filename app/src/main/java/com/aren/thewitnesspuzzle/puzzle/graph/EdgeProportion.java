...
public class EdgeProportion {
    ...
    public Vector2 getProportionPoint(){
        if(reverse) return new Vector2(MathUtils.lerp(edge.to.x, edge.from.x, proportion), MathUtils.lerp(edge.to.y, edge.from.y, proportion));
    ...
    public Vector2 getProportionMiddlePoint(){
        if(reverse) return new Vector2(MathUtils.lerp(edge.to.x, edge.from.x, proportion * 0.5f), MathUtils.lerp(edge.to.y, edge.from.y, proportion * 0.5f));
